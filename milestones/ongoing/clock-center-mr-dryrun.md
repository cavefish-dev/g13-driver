...
- [ ] The line-1 clock renders centered on the physical LCD.
- [ ] Toggling to dry-run (MR key) lights the MR LED; returning to active turns it off.
- [ ] With the M-key indicator turned off (Settings), MR stays dark even in dry-run.
