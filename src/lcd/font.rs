...
//!
//! Transcribed verbatim from the canonical
//! <https://raw.githubusercontent.com/adafruit/Adafruit-GFX-Library/master/glcdfont.c>
//! (indices 0x20..=0x7E of the flat 256-glyph `font[]` array). Letterforms are
//! verified visually in the GUI preview (Task 7) and on hardware, not by unit test.
